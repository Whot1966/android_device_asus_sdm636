...
LOCAL_C_INCLUDES := \
        ...
        $(LOCAL_PATH)/util \
        $(LOCAL_PATH)/HAL3 \
        device/asus/sdm660-common/qcom-caf/media/libstagefrighthw \
        device/asus/sdm660-common/qcom-caf/media/mm-core/inc \
...
LOCAL_C_INCLUDES += \
        device/asus/X00TD/qcom-caf/display/libqservice
